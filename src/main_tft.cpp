...
//   mqttClient.subscribe("octoPrint/event/plugin_spoolmanager_spool_selected", onSpoolInfoReceived);
//   mqttClient.subscribe("octoPrint/event/DisplayLayerProgress_timerTrigger", onPrintProgressReceived);
